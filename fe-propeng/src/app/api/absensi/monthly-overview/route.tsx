...
export async function GET(request: NextRequest) {
  ...
  // Construct the backend URL for the monthly overview endpoint
  const backendUrl = `${API_BASE_URL}/api/absen/kelas/${kelasId}/monthly-overview/`;
  console.log(`[API Route /api/absensi/monthly-overview] Fetching from: ${backendUrl}`);
  ...
  try {
    ...
    if (!backendResponse.ok) {
      ...
      return NextResponse.json(
        { message: errorData.message || "Failed to fetch monthly class attendance overview." },
