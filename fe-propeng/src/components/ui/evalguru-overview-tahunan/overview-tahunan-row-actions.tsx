...
const generateTeacherEvaluationPdfForRow = (
    ...
    if (variables && Array.isArray(variables)) {
        variables.forEach((variableData: any) => {
            ...
            } else { doc.setFontSize(9); doc.setFont("helvetica"); doc.text("Tidak ada indikator.", pageMargin + 5, currentY); currentY += smallLineHeight; }
            doc.setFontSize(9.5); doc.setFont("helvetica", "bold"); doc.text(`Rata-Rata ${variableName}`, pageMargin, currentY); doc.text(variableAverageScore, pageWidth - pageMargin, currentY, { align: 'right' }); currentY += lineHeight * 1.5;
        });
    }
